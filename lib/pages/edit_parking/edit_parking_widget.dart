...
import 'edit_parking_model.dart';
export 'edit_parking_model.dart';

class EditParkingWidget extends StatefulWidget {
  const EditParkingWidget({super.key});

  @override
  State<EditParkingWidget> createState() => _EditParkingWidgetState();
}

class _EditParkingWidgetState extends State<EditParkingWidget> {
  late EditParkingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditParkingModel());
                          ...
                          children: [
                            ...
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed('editeParkingDetails');
                                },
                                text: 'Continue',
                                options: FFButtonOptions(
                                  height: 40.0,
